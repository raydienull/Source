...
#include "../common/version.h"	// build number, generated by the build system
...
nowinsock:		g_Log.Event(LOGL_FATAL|LOGM_INIT, "Winsock 1.1 not found!\n");
	...
	g_Log.Event(LOGM_INIT, "%s, compiled at " __DATE__ " (" __TIME__ "), build #%d (git %s)\n", g_szServerDescription, SPHERE_BUILD_NUMBER, SPHERE_GIT_HASH);
